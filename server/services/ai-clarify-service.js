...
**具体性门控规则 — 以下任一情况出现，禁止设置 readyForReview=true：**
...
- 示例: vaguenessWarnings: ["「5~10个关卡」未说明具体关卡名称和机制，请至少列出前3关", "「原创剧情」未说明剧情主线和章节结构"]

**⚠️ 每轮结束前必须执行自我审查（Self-Review）：**
在生成 JSON 回复前，逐条检查当前 SRS 的 scopeIn、acceptanceCriteria、technicalConstraints、description，对照上述 5 类模糊规则：

1. 扫描 scopeIn 中是否有 "X~Y 个" 数量范围但无具体名称？
2. 扫描描述中是否有 "剧情""NPC""BOSS""关卡""地形""人物" 但无名字/设定？
3. 扫描 technicalConstraints 中是否有 "现代XXX""合适的XXX" 但未做决策？
4. 扫描 acceptanceCriteria 中是否每条都有可量化数字指标？
5. 扫描 message 中是否有主观形容词（"有趣""独特""好玩"）但无具体描述？
