...
## 6 段式结构（必须严格遵守，section header 一字不差）
...
### 待验证假设
**bullet 列表**（每条 1 行），从用户确认的假设复述。**开头「假设编号」部分用双星号加粗**，风险等级用方括号标记。例如：
...
4. **假设段**：带编号 **A-NNN** 加粗 + 风险等级 [低/中/高] + 复述原话
