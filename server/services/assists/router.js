...
- **visual** （视觉预览）：生成 3 张方向图，让用户选一个最像的方向。适合：用户已经定了 1 个方向、但想看视觉具象化时。
- **pains** （痛点溯源）：挖掘需求描述中的隐藏痛点，按效率/体验/成本/风险/质量归类。适合：用户说得清"做什么"但说不清"为什么要做"时。
- **stakeholders** （干系人地图）：识别所有相关角色（决策者/用户/运营/依赖方），分析关注点和阻力。适合：需求影响面较大、涉及多方时。
- **risks** （风险预警）：扫描技术可行性/外部依赖/时间估算/合规等方面的潜在风险。适合：描述中涉及新技术/外部依赖/不确定因素时。
- **assumptions** （假设清单）：提取需求描述中的隐藏假设。适合：描述里有很多隐含前提需要验证时。
...
## 输出（严格 JSON）
{
  "method": "scenarios|diagnosis|tradeoff|arch|decision_tree|visual|pains|stakeholders|risks|assumptions",
...
function fallbackPick(ctx) {
  ...
  const basePriority = {
    vague: includeVisual ? ['tradeoff', 'decision_tree', 'arch', 'scenarios', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders', 'visual']
                        : ['tradeoff', 'decision_tree', 'arch', 'scenarios', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders'],
    conflicted: includeVisual ? ['scenarios', 'decision_tree', 'arch', 'tradeoff', 'diagnosis', 'stakeholders', 'pains', 'risks', 'assumptions', 'visual']
                              : ['scenarios', 'decision_tree', 'arch', 'tradeoff', 'diagnosis', 'stakeholders', 'pains', 'risks', 'assumptions'],
    null: null,  // 占位，下面用原 clarity-based
  }[diagnosisType];

  const priority = basePriority || {
    low:    includeVisual ? ['scenarios', 'tradeoff', 'arch', 'decision_tree', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders', 'visual'] : ['scenarios', 'tradeoff', 'arch', 'decision_tree', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders'],
    medium: includeVisual ? ['scenarios', 'tradeoff', 'arch', 'decision_tree', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders', 'visual'] : ['scenarios', 'tradeoff', 'arch', 'decision_tree', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders'],
    high:   includeVisual ? ['arch', 'decision_tree', 'scenarios', 'tradeoff', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders', 'visual'] : ['arch', 'decision_tree', 'scenarios', 'tradeoff', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders'],
    null:   includeVisual ? ['scenarios', 'tradeoff', 'arch', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders', 'visual'] : ['scenarios', 'tradeoff', 'arch', 'diagnosis', 'pains', 'risks', 'assumptions', 'stakeholders'],
