...
async function chatAssist(reqId, method, extraBody) {
  ...
  const methodTitles = { decision_tree:'🌳 决策树', scenarios:'👥 场景', tradeoff:'⚖️ 取舍', arch:'🏗️ 架构', diagnosis:'🩺 体检', visual:'🎨 视觉', competitive:'🏢 竞品', reference:'🏛 借鉴', pains:'🔥 痛点', stakeholders:'👥 干系人', risks:'⚠️ 风险', assumptions:'📌 假设', music:'🎵 音乐', video:'🎬 视频', image_gen:'🖼️ 图片', clean:'🧹 清理', screenplay:'📖 剧本', document_gen:'📄 文档' };
  if (c) {
